...
export const Default: Story = {
  args: {
    variant: 'body1',
    children:
      'This is the default body text with improved line height and tracking',
  },
};
    ...
    <div className='space-y-6 max-w-3xl'>
      <div className='space-y-4'>
        <Typography variant='h1'>
          H1 - Main Heading (Responsive: text-4xl → text-5xl)
        </Typography>
        <Typography variant='h2'>
          H2 - Section Heading (Responsive: text-3xl → text-4xl)
        </Typography>
        <Typography variant='h3'>
          H3 - Subsection Heading (Responsive: text-2xl → text-3xl)
        </Typography>
        <Typography variant='h4'>
          H4 - Sub-subsection (Responsive: text-xl → text-2xl)
        </Typography>
        <Typography variant='h5'>
          H5 - Minor Heading (Responsive: text-lg → text-xl)
        </Typography>
      ...
      <div className='space-y-4'>
        <Typography variant='subtitle1'>
          Subtitle 1 (Responsive: text-base → text-lg)
        </Typography>
        <Typography variant='subtitle2'>
          Subtitle 2 (Responsive: text-sm → text-base)
        </Typography>
  ...
  render: () => (
    <div className='space-y-4 max-w-2xl'>
      <div className='space-y-2'>
        <Typography variant='body1'>
          Normal text with improved line height
        </Typography>
      ...
      <div className='space-y-2'>
        ...
        <Typography variant='body1' align='justify'>
          Justified text example with improved line height for better
          readability. This demonstrates how the text flows with the new line
          height settings.
        </Typography>
      </div>
  ...
  render: () => (
    <div className='space-y-8 max-w-4xl'>
      <div className='space-y-4'>
        ...
        <Typography variant='body1'>
          This heading scales from text-4xl on mobile to text-5xl on larger
          screens. Notice the improved line height and letter spacing for better
          readability.
        </Typography>
      </div>
      ...
      <div className='space-y-4'>
        ...
        <Typography variant='body1'>
          This heading scales from text-3xl to text-4xl. The line height and
          tracking are optimized for each size to maintain readability.
        </Typography>
      </div>
      ...
      <div className='space-y-4'>
        ...
        <Typography variant='body1'>
          Subtitles scale from text-base to text-lg, with appropriate line
          height adjustments for optimal readability at each size.
        </Typography>
      </div>
    </div>
  ),
